...
export default function Navbar() {
  ...
  const isActive = (path: string) => pathname === path ? "dark:text-white text-black" : "opacity-50";

  return (
    <>
      {/* Desktop Nav */}
      <div className="w-full h-20 text-xl dark:text-gray-300 text-gray-800 hidden md:flex flex-row justify-end items-center gap-5 pr-10 fixed top-0">
      ...
      {/* Mobile Nav */}
      <div className="w-full h-20 text-xl dark:text-gray-300 flex md:hidden justify-around items-center py-3 fixed bottom-0">
