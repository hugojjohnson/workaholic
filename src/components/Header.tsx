...
export default function Header(): React.ReactElement {
    ...
    return (<div>
        ...
        {
            user && <div className="w-full h-20 text-xl text-gray-300 bg-[#242424] flex flex-row md:justify-end items-center justify-around md:pr-10 visible md:hidden fixed md:static bottom-0">
